...
import net.orekyuu.iroha.delegate.CreatePreparedStatementDelegator;
...
public class AggregateConnection extends WrapAdaptor implements Connection {
  ...
  private final CreatePreparedStatementDelegator createPreparedStatementDelegator;
  ...
  public AggregateConnection(List<Connection> connections) {
    ...
    this.createPreparedStatementDelegator = new CreatePreparedStatementDelegator(connections, this);
  ...
  public PreparedStatement prepareStatement(
      ...
      throws SQLException {
    return createPreparedStatementDelegator.delegate(
        c -> c.prepareStatement(sql, resultSetType, resultSetConcurrency, resultSetHoldability));
  }

  @Override
  public PreparedStatement prepareStatement(String sql) throws SQLException {
    return createPreparedStatementDelegator.delegate(c -> c.prepareStatement(sql));
  }

  @Override
  public PreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
    return createPreparedStatementDelegator.delegate(c -> c.prepareStatement(sql, columnIndexes));
  }

  @Override
  public PreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
    return createPreparedStatementDelegator.delegate(c -> c.prepareStatement(sql, columnNames));
  }
