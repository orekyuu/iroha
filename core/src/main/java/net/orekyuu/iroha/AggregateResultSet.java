...
public class AggregateResultSet extends WrapAdaptor implements ResultSet {
  private final List<ResultSet> resultSets;
  private final Statement statement;
  private final ExecuteAllMethodSafelyDelegator<ResultSet> executeAllMethodSafelyDelegator;
  private final SQLWarningDelegator<ResultSet> sqlWarningDelegator;
  private ResultSet current;

  public AggregateResultSet(List<ResultSet> resultSets, Statement statement) {
  ...
  public void close() throws SQLException {
    executeAllMethodSafelyDelegator.executeSafely(ResultSet::close);
  }
  ...
  public void clearWarnings() throws SQLException {
    executeAllMethodSafelyDelegator.executeSafely(ResultSet::clearWarnings);
  }
  ...
  public void setFetchDirection(int direction) throws SQLException {
    executeAllMethodSafelyDelegator.executeSafely(rs -> rs.setFetchDirection(direction));
  }
  ...
  public void setFetchSize(int rows) throws SQLException {
    executeAllMethodSafelyDelegator.executeSafely(rs -> rs.setFetchSize(rows));
  }
